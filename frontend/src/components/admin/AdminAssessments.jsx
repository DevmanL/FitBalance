...
const AdminAssessments = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Gestión de Valoraciones</h1>
        <p className="text-gray-600 mt-1">Administra todas las valoraciones del sistema</p>
      </div>
